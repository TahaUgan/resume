...
// Store rooms in localStorage if not already present
if (!localStorage.getItem('rooms')) {
    localStorage.setItem('rooms', JSON.stringify(rooms));
}

function getAmenitiesForCategory(category) {
    const baseAmenities = ['Wi-Fi', 'TV', 'Air Conditioning', 'Mini Bar'];
    switch(category) {
        case 'Deluxe':
            return [...baseAmenities, 'City View', 'Premium Toiletries', 'Room Service'];
        case 'Suite':
            return [...baseAmenities, 'Living Room', 'Kitchenette', 'Premium Toiletries', 'Room Service', 'City View', 'Jacuzzi'];
        case 'Standard':
